...
locals {
  resolver_fields = {
    ...
    "Query.getGemmaModelStatus"              = "Query"
    "Query.getGemmaAuditDashboard"           = "Query"
    ...
    "Mutation.publishEmergencySyncPackage"   = "Mutation"
    "Mutation.queueOfflineSos"               = "Mutation"
    "Mutation.syncOfflineSosQueue"           = "Mutation"
    "Mutation.evaluateGemmaOutput"           = "Mutation"
    "Mutation.generateOfflineCitizenInsight" = "Mutation"
  }
}
